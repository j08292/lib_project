...
<section id="page-title">
	<div class="container clearfix">
		<h1>
			<spring:message code="qna.detail.title" />
		</h1>
		<ol class="breadcrumb">
			<li><a href="${pageContext.request.contextPath}/main/main.do">Home</a></li>
			<li><a
				href="${pageContext.request.contextPath}/board/qnaList.do">QnA
					List</a></li>
			<li class="active">QnA Detail</li>
		</ol>
	</div>
</section>
<!-- #page-title end -->
		...
		<div class="container clearfix">
			...
			<div>
				...
				<input type="hidden" name="qna_num" id="qna_num"
					value="${qnaCommand.qna_num}"> <input type="hidden"
					name="mem_id" id="mem_id" value="${userId}">
				<!-- 목록출력 -->
				<div id="output"></div>
