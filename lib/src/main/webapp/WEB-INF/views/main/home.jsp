			...
			<div class="content-wrap">
					...
					<div class="row clearfix">
						...
						<div class="col-lg-7">
							...
							<div style="position: relative; margin-bottom: -60px;" class="ohidden" data-height-lg="426" data-height-md="567" data-height-sm="470" data-height-xs="287" data-height-xxs="183">
								<img src="${pageContext.request.contextPath}/resources/user/images/services/main-fbrowser.png" style="position: absolute; top: 0; left: 0;" data-animate="fadeInUp" data-delay="100" alt="Chrome">
								<img src="${pageContext.request.contextPath}/resources/user/images/services/main-fmobile.png" style="position: absolute; top: 0; left: 0;" data-animate="fadeInUp" data-delay="400" alt="iPad">
							</div>
						...
						<div>
							...
							<div class="center bottommargin">
								<a href="http://vimeo.com/101373765" data-lightbox="iframe" style="position: relative;">
									<img src="${pageContext.request.contextPath}/resources/user/images/services/video.jpg" alt="Video">
									<span class="i-overlay nobg"><img src="${pageContext.request.contextPath}/resources/user/images/icons/video-play.png" alt="Play"></span>
								</a>
							</div>
				...
				<div id="portfolio" class="portfolio-nomargin portfolio-notitle portfolio-full clearfix">
					...
					<article class="portfolio-item pf-media pf-icons">
						<div class="portfolio-image">
							<a href="portfolio-single.html">
								<img src="${pageContext.request.contextPath}/resources/user/images/portfolio/4/1.jpg" alt="Open Imagination">
							</a>
					...
					<article class="portfolio-item pf-illustrations">
						<div class="portfolio-image">
							<a href="portfolio-single.html">
								<img src="${pageContext.request.contextPath}/resources/user/images/portfolio/4/2.jpg" alt="Locked Steel Gate">
							</a>
							<div class="portfolio-overlay">
					...
					<article class="portfolio-item pf-graphics pf-uielements">
						<div class="portfolio-image">
							<a href="#">
								<img src="${pageContext.request.contextPath}/resources/user/images/portfolio/4/3.jpg" alt="Mac Sunglasses">
							</a>
							<div class="portfolio-overlay">
					...
					<article class="portfolio-item pf-icons pf-illustrations">
						<div class="portfolio-image">
							<a href="portfolio-single.html">
								<img src="${pageContext.request.contextPath}/resources/user/images/portfolio/4/4.jpg" alt="Open Imagination">
							</a>
					...
					<article class="portfolio-item pf-uielements pf-media">
						<div class="portfolio-image">
							<a href="portfolio-single.html">
								<img src="${pageContext.request.contextPath}/resources/user/images/portfolio/4/5.jpg" alt="Console Activity">
							</a>
							<div class="portfolio-overlay">
								<a href="${pageContext.request.contextPath}/resources/user/images/portfolio/full/5.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
								<a href="portfolio-single.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
							</div>
						</div>
						<div class="portfolio-desc">
					...
					<article class="portfolio-item pf-graphics pf-illustrations">
						<div class="portfolio-image">
							<a href="portfolio-single.html">
								<img src="${pageContext.request.contextPath}/resources/user/images/portfolio/4/6.jpg" alt="Open Imagination">
							</a>
							<div class="portfolio-overlay" data-lightbox="gallery">
								<a href="${pageContext.request.contextPath}/resources/user/images/portfolio/full/6.jpg" class="left-icon" data-lightbox="gallery-item"><i class="icon-line-stack-2"></i></a>
								<a href="${pageContext.request.contextPath}/resources/user/images/portfolio/full/6-1.jpg" class="hidden" data-lightbox="gallery-item"></a>
								<a href="${pageContext.request.contextPath}/resources/user/images/portfolio/full/6-2.jpg" class="hidden" data-lightbox="gallery-item"></a>
								<a href="${pageContext.request.contextPath}/resources/user/images/portfolio/full/6-3.jpg" class="hidden" data-lightbox="gallery-item"></a>
								<a href="portfolio-single-gallery.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
							</div>
						</div>
						<div class="portfolio-desc">
					...
					<article class="portfolio-item pf-uielements pf-icons">
						<div class="portfolio-image">
							<a href="portfolio-single-video.html">
								<img src="${pageContext.request.contextPath}/resources/user/images/portfolio/4/7.jpg" alt="Backpack Contents">
							</a>
							<div class="portfolio-overlay">
					...
					<article class="portfolio-item pf-graphics">
						<div class="portfolio-image">
							<a href="portfolio-single.html">
								<img src="${pageContext.request.contextPath}/resources/user/images/portfolio/4/8.jpg" alt="Sunset Bulb Glow">
							</a>
							<div class="portfolio-overlay">
								<a href="${pageContext.request.contextPath}/resources/user/images/portfolio/full/8.jpg" class="left-icon" data-lightbox="image"><i class="icon-line-plus"></i></a>
								<a href="portfolio-single.html" class="right-icon"><i class="icon-line-ellipsis"></i></a>
							</div>
						</div>
						<div class="portfolio-desc">
				...
				<div class="container clearfix">
					...
					<div class="col_one_third bottommargin-sm center">
						<img data-animate="fadeInLeft" src="${pageContext.request.contextPath}/resources/user/images/services/iphone6.png" alt="Iphone">
					</div>
							...
							<div class="slider-wrap">
								<div class="slide">
									<div class="testi-image">
										<a href="#"><img src="${pageContext.request.contextPath}/resources/user/images/testimonials/3.jpg" alt="Customer Testimonails"></a>
									</div>
								...
								<div class="slide">
									<div class="testi-image">
										<a href="#"><img src="${pageContext.request.contextPath}/resources/user/images/testimonials/2.jpg" alt="Customer Testimonails"></a>
									</div>
									<div class="testi-content">
								...
								<div class="slide">
									<div class="testi-image">
										<a href="#"><img src="${pageContext.request.contextPath}/resources/user/images/testimonials/1.jpg" alt="Customer Testimonails"></a>
									</div>
									<div class="testi-content">
				...
				<div class="container clear-bottommargin clearfix">
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 bottommargin">
							<div class="ipost clearfix">
								<div class="entry-image">
									<a href="#"><img class="image_fade" ="${pageContext.request.contextPath}/resources/user/images/magazine/thumb/1.jpg" alt="Image"></a>
								</div>
						...
						<div class="col-md-3 col-sm-6 bottommargin">
							<div class="ipost clearfix">
								<div class="entry-image">
									<a href="#"><img class="image_fade" src="${pageContext.request.contextPath}/resources/user/images/magazine/thumb/2.jpg" alt="Image"></a>
								</div>
								<div class="entry-title">
						...
						<div class="col-md-3 col-sm-6 bottommargin">
							<div class="ipost clearfix">
								<div class="entry-image">
									<a href="#"><img class="image_fade" src="${pageContext.request.contextPath}/resources/user/images/magazine/thumb/3.jpg" alt="Image"></a>
								</div>
								<div class="entry-title">
						...
						<div class="col-md-3 col-sm-6 bottommargin">
							<div class="ipost clearfix">
								<div class="entry-image">
									<a href="#"><img class="image_fade" src="${pageContext.request.contextPath}/resources/user/images/magazine/thumb/4.jpg" alt="Image"></a>
								</div>
								<div class="entry-title">
