		...
		<header id="header" class="transparent-header full-header" data-sticky-class="not-dark">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.html" class="standard-logo" data-dark-logo="${pageContext.request.contextPath}/resources/user/images/logo-dark.png"><img src="${pageContext.request.contextPath}/resources/user/images/logo.png" alt="Canvas Logo"></a>
						<a href="index.html" class="retina-logo" data-dark-logo="${pageContext.request.contextPath}/resources/user/images/logo-dark@2x.png"><img src="${pageContext.request.contextPath}/resources/user/images/logo@2x.png" alt="Canvas Logo"></a>
					</div><!-- #logo end -->
