			...
			success:function(data){				
				...
				if(count < 0 || list == null){
					...
					$(list).each(function(index,item){
						...
						output += '<input type="button" data-num="'+item.qna_re_num+'" data-id="'+item.mem_id+'"  class="btn btn-xs btn-warning" value="수정"> ';
						output += '<input type="button" data-num="'+item.qna_re_num+'" data-id="'+item.mem_id+'" class="btn btn-xs btn-danger" value="삭제">';
