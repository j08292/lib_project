...
//도서대출 현황 - 배송정보 확인 팝업창
function popup(rent_num){
	window.open("delivery.do?rent_num="+rent_num,"window","width=480px,height=400px,scrollbars=no,toolbar=no,location=no,directories=no,top=100,left=100,noresize"); 
}